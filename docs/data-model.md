...
Сверено 2026-09-20 с **0.1.0-alpha.16**. Таблицы этапа 1, RunAttempt, receipt,
job input, `agency_job_needs_input`, знания, паспорт, профили работ и библиотека
навыков отдела уже в миграциях. Ниже — контракт полей и переходов,
