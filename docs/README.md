...
Сверено 2026-09-17 с исходниками **0.1.0-alpha.13**. Введение и границы установки —
...
0. [Анализ и план развития](operating-model.md) — что есть, сравнение с Linear,
   Paperclip, Multica, Bitrix24 и lane-stack, пробелы P0–P2, инструкция делегирования.
