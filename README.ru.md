...
руководитель, исполнитель или проверяющий — в промпте запуска. Инструкции и
...
разработку, исследования и тексты с руководителем, исполнителями, проверяющими,
регламентом и должностными инструкциями на русском или английском — или создать свои
отделы, сотрудников и правила с нуля. Стартовые записи — обычные данные: их можно
