...
> **Статус:** `0.1.0-alpha.17`, рабочая альфа. Постоянные данные, управляемые
...
Подсказка к запуску может выбрать **low / medium / high** рассуждение для
исполнителя или помощника только на эту попытку. Профиль в карточке не меняется
(у писателя по умолчанию medium).
