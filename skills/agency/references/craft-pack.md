...
По одному отделу. Не все пятнадцать параллельно. Зафиксированы (2026-09-20): Тексты, Реклама, Дизайн, SEO, Маркетинг, Соцсети, Исследования. Остались киты: Инфра, Автоматизация, Продажи, Офис владельца — стол только если после живой работы дыра. После фиксации пакета обнови [карту поступления](routing.md) и [работу отделов](departments.md).
