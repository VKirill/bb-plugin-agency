...
export const AGENCY_RULE_GROUPS: RuleGroup[] = [
  ...
  },
  {
    ...
    fields: [
      { key: "autoLearn", label: "Отдел учится сам", kind: "bool", hint: <><p><Tr text={"Включено — урок принимается сразу, вы получаете сообщение и можете поправить его или убрать в «Знаниях». Так отдел копит опыт без вашего хода."}/></p><p><Tr text={"Выключено — урок ждёт вашего решения предложением. Строже, но каждый раз требует внимания."}/></p><p><Tr text={"Принять или убрать запись отдела может и его руководитель; знания проекта и всего Агентства остаются за владельцем."}/></p></> },
