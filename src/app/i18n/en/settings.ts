...
export const EN_SETTINGS: Record<string, string> = {
  ...
  "Включено — кандидаты в уроки доступны руководителю в состоянии задачи. Он проверяет причину, исправление и результат, затем принимает полезный урок без вашего участия.": "On — lesson candidates appear in the lead’s job state. The lead checks the cause, correction and evidence before accepting a useful lesson without your involvement.",
  "Выключено — кандидаты остаются предложениями в «Знаниях» для ручного разбора. Статистика задачи сама по себе не становится правилом.": "Off — candidates remain proposals in Knowledge for manual review. Job statistics alone never become a rule.",
