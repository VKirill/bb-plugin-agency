...
export const EN_SETTINGS: Record<string, string> = {
  ...
  "Модель и уровень рассуждения, которые подставляются в форму «Создать сотрудника» для каждого типа роли. В форме всё можно поменять.": "The model and reasoning level pre-filled in the “Create employee” form for each role type. Everything can be changed in the form.",
  "Руководитель": "Lead",
