...
export const CLI_EXAMPLES: Record<CliRoutedOperation, unknown> = {
  ...
  getProjectPassport: { bbProjectId: "proj_…" },
  savePassport: { bbProjectId: "proj_…", expectedRevision: 0, header: "Плагин «Агентство» для BB…", sections: [{ key: "limits", text: "Не трогаем базу вручную" }] },
  buildProjectPassport: { bbProjectId: "proj_…" },
  rollbackPassport: { bbProjectId: "proj_…", revision: 3 },
  getPassportSettings: {},
  savePassportSettings: { expectedRevision: 0, enabled: true, model: "deepseek/deepseek-v4.1-flash", keySource: "env-catalog", keyName: "OPENROUTER_API_KEY", triggerEveryN: 10 },
  ...
  getJobDiagnostics: { jobId: "AG-177", limit: 50 },
