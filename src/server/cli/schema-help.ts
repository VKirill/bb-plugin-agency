...
export const CLI_COMMAND_SPECS = [
  ...
  { name: "job", summary: "Задача", usage: "bb agency job create|get|update|assign|transition|attach-input|depend|undepend|next-step|report-needs-input|answer-needs-input|stale-answer|ask-owner|attempts|comment|usage|return" },
