...
export const CLI_OPERATIONS = {
  ...
  setSkillPool: { input: z.object({ departmentId: z.string(), skillIds: z.array(z.string()).max(60) }).strict(), summary: "Заменить библиотеку навыков отдела; правит владелец или руководитель этого отдела" },
