...
const COPY = {
  ru: {
    ...
    verdict: "Первая строка отчёта И поля comment команды job submit: `Вердикт: принять` или `Вердикт: доработать`.",
  },
  en: {
    ...
    verdict: "First line of the report AND of the job submit comment: `Verdict: accept` or `Verdict: rework`.",
  },
} as const;
