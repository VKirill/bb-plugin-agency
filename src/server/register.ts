        ...
        void sendOwnerMessage(
          {
            text:
              lesson.status === "accepted"
                ...
                : rules.autoLearn
                  ? `Собран кандидат в урок: «${lesson.title}». Он доступен руководителю в состоянии задач отдела для проверки причины, исправления и применимости. Автоматический итог не стал новым правилом.`
                  : `Собран кандидат в урок: «${lesson.title}». Он остаётся предложением в «Знаниях» для ручного разбора; автоматический итог не стал новым правилом.`,
