...
Файлы открываются по клику в закрываемой правой вкладке BB. Единый
Markdown-редактор на TipTap читает и правит текст без переключения вкладок; YAML
свёрнут в свойства документа, схемы и специальные блоки редактируются отдельно.
Сохранение создаёт новую версию на машине и в папке привязанного проекта.
Пример форматирования — [docs/examples/markdown-showcase.md](docs/examples/markdown-showcase.md).
